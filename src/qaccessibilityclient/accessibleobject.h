...
//    LayeredPane    = 0x00000080,
    ...
    */
    ...
    /*!
      \enum QAccessibilityClient::AccessibleObject::LocaleType
    ...
    */
    ...
    /*!
        ...
        be provided in Accessible::Description, if available. A short, one
        or two word label for the image should be provided in Accessible::Name.
